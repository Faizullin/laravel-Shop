                                        	...
                                        	<div v-for="product in products" class="col-xl-4 col-lg-6 col-6 ">
                                                <div class="products-three-single w-100  mt-30">
                                                    <div class="products-three-single-img"> <a
                                                        ...
                                                        </div> <a @click.prevent="addToCart(product,1)" class="addcart btn--primary style2">
                                                            Add To Cart </a>
                                                                    ...
                                                                    <div class="popup-right-content">
                                                                        ...
                                                                        <div class="color-varient"> 
                                                                        	<template v-for="groupProduct in popupProduct.group_products">
                                                                        		<a v-for="groupProductColor in groupProduct.colors" 
	                                                                                ...
	                                                                                <span class="">{{ groupProductColor.title }}</span> 
	                                                                            </a>
                                                                        	</template>
                                                                        </div> 
                                                                        <div class="add-product">
                                                                            ...
                                                                            <div class="button-group">
                                                                                ...
                                                                                <button @click="addToCart(product)" class="btn--primary "> Add to
                                                                                    Cart </button>
                                                                            </div>
                                                                        </div>
                                ...
                                <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                                    ...
                                    <div class="slider-box">
                                        ...
                                        <button @click.prevent="filterProducts"
                                        	class="filterbtn" type="submit"> Filter </button>
                                    </div>
                                </div>
