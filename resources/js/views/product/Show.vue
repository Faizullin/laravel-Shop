                ...
                <div class="row mt--30">
                    <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
                        <div class="single-product-box one">
                            <div v-if="product" class="big-product single-product-one slider-for">
                            ...
                            <div class="navholder">
                                <div v-if="product" class="product-slicknav single-product-one-nav slider-nav">
                                    <div v-for="productImage in product.product_images"> 
                    ...
                    <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
                        <div class="shop-details-top-right ">
                            <div v-if="product"  class="shop-details-top-right-content-box">
                                ...
                                <ul class="shop-details-top-info">
                                    ...
                                    <li>
                                        <span>Vendor:</span> 
                                        <span v-if="product.user"> {{ product.user.name }}</span>
                                        <span v-else="" class="text-muted text-capitalize"> Unknown</span>
                                    </li>
                                </ul>
                                <div class="shop-details-top-price-box">
                                    <h3>${{ product.price.toFixed(2) }} <del>$50.00</del></h3>
                                    <p>(+15% Vat Included)</p>
                                </div>
...
<!--                                 <div class="shop-details-top-color-sky-box">
                                ...
                                <div class="product-quantity">
                                    ...
                                    <div class="product-quantity-box d-flex align-items-center flex-wrap">
                                        ...
                                        <div v-if="product.isPublished" class="product-quantity-check"> 
                                            <i class="flaticon-select"></i>
                                            <p >In Stock</p>
                                        </div>
                                        <div v-else="" class="product-quantity-check"> 
        ...
        <section class="product pt-60 pb-60 wow fadeInUp overflow-hidden ">
            <div class="container">
                ...
                <div class="row wow fadeInUp animated">
                    <div v-if="product" class="tab-content" id="pills-tabContent-two">
...
<script >
    ...
    export default {
        ...
        methods:{
            getProduct(){
                axios.get(BASE_URL+`/api/products/${this.$route.params.id}`).then((res)=>{
