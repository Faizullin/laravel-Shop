                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="menu-info d-flex justify-content-between align-items-center">
                                        <div class="menubar"> <span></span> <span></span> <span></span> </div> <a href="index.html" class="logo"> <img src="/src/assets/images/logo/logo.png"
                                                alt=""> </a>
                            ...
                            <ul class="page-dropdown-menu">
                                ...
                                <li class="dropdown-list"> <a href="#0"> <span>Pages</span> <span class="menuarrow"> <i
                                    ...
                                    <ul class=" dropdown ">
                                        ...
                                        <li><router-link :to="{name:'cart.index'}"> Cart </router-link></li>
                                        <li><router-link :to="{name:'contact'}">Contact</router-link></li>
                                        <li><router-link :to="{name:'auth.myAccount'}"> My Account </router-link></li>
                                        ...
                                        <div class=" d-flex align-items-center justify-content-between ">
                                            <nav>
                                                <ul class="page-dropdown-menu d-flex align-items-center justify-content-center">
                                                    ...
                                                    <li class="dropdown-list"> <a href="#0"> <span>Pages </span> <span class="menuarrow"> <i class="flaticon-down-arrow"></i>
                                                            </span> </a>
                                                        <ul class="dropdown">
                                                            <li><router-link :to="{name:'about'}">About Us </router-link></li>
                                                            <li><router-link :to="{name:'cart.index'}">Cart</router-link></li>
                                                    ...
                                                    <li class="dropdown-list"> <router-link :to="{name:'contact'}">Contact</router-link> </li>
                                                </ul>
                                            </nav>
                                            ...
                                            <div class="right d-flex align-items-center justify-content-end">
                                                <ul class="main-menu__widge-box d-flex align-items-center ">
                                                    <li class="d-lg-block d-none">
                                                        <router-link :to="{name:'auth.myAccount'}">
                                                            <i class="flaticon-user"></i>
                                                        </router-link>
                                                    </li>
                                                    <li class="d-lg-block d-none">
                                                        <router-link :to="{path:'/wishlist'}"  class="number">
                                                            <i class="flaticon-heart"></i>
                                                            <span class="count">(2)</span>
                                                        </router-link> 
                                                    </li>
                                                    <li class="cartm">
                                                        <router-link :to="{name:'cart.index'}" class="number cart-icon">
                                                            <i class="flaticon-shopping-cart"></i>
                                    ...
                                    <ul
                                        ...
                                        <li class="dropdown-list"> <a href="#0"> <span>Pages </span> <span
                                            ...
                                            <ul class="dropdown">
                                                ...
                                                <li><router-link :to="{name:'cart.index'}">Cart</router-link></li>
                                                <li><router-link :to="{name:'contact'}">Contact</router-link></li>
                                                <li><router-link :to="{name:'auth.myAccount'}">My_Account</router-link></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown-list"> <router-link :to="{name:'contact'}">Contact</router-link> </li>
                                    </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 mt-30 wow fadeInUp animated">
                        <div class="footer-default__single-box">
                            ...
                            <ul class="footer-links">
                                <li><router-link :to="{name:'auth.myAccount'}">Account</router-link></li>
                                <li><router-link :to="{name:'auth.login'}">Sign In</router-link></li>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mt-30 wow fadeInUp animated">
                        <div class="footer-default__single-box">
                            ...
                            <ul class="footer-links">
                                <li><router-link :to="{name:'about'}">About us</router-link></li>
                                <li><router-link :to="{name:'products.index'}">New Products</router-link></li>
                            </ul>
                        </div>
                    </div>
  ...
  export default {
    ...
    methods:{
        getCartNumber(){
            ...
            if(cart){
                this.cart_number = Object.keys(cart).length;
            }else{
                this.cart_number = 0;
            }
